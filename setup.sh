...
# before it can log anything. The wrapper invokes python3 by absolute
# path, which sidesteps the issue.
...
exec "$PY_ABS" "$HOST_BIN" "\$@"
EOF_LAUNCHER
chmod +x "$LAUNCHER"
ok "Wrote launcher: $LAUNCHER (python3=$PY_ABS)"
